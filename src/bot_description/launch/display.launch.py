...
def generate_launch_description():
    ...
    robot_description = ParameterValue(Command([ # passing the urdf file that we created 
            "xacro ",
    ...
    joint_state_publisher_gui_node = Node( # it is passing the fake encoder values 
