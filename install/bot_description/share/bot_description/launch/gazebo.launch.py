...
def generate_launch_description():
    ...
    gazebo = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory("ros_gz_sim"), "launch"), "/gz_sim.launch.py"]),#directly writing here otherewise write this in terminal to launch gazebo
                launch_arguments={
    ...
    gz_spawn_entity = Node(
        ...
        arguments=[
            ...
            "-x", "0.0",  
            "-y", "0.0",  
            "-z", "2.0",  # basically to spawn the bot 2m above the ground 
            "-R", "0.0", 
            "-P", "0.0",
            "-Y", "0.0",
        ],
    ...
    gz_ros2_bridge = Node(  # to bridge the topics of gazebo to ros topics
